...
class ReportsController extends Controller
{
    ...
    {
        $reports = Report::onlyTrashed()->get()->map(function ($report) {
        ...
        $rooms = Room::all();
        return view('bank_sampah.recycle_bin.report.index', compact('reports','rooms'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('bank_sampah.recycle_bin.report.view', compact('reports', 'rooms'));
    }
    ...
    public function restore($id)
    {
        ...
        $report->restore();
        return redirect()->route('report.index')->with('success', 'Data berhasil dikembalikan.');
    }
