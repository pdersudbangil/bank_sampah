                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($report->trashes); ?></td>
                        ...
                        <div class="modal fade" id="editModal<?php echo e($report->id); ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="<?php echo e(route('report.update', $report->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bank_sampah\resources\views/bank_sampah/dashboard.blade.php ENDPATH**/ ?>