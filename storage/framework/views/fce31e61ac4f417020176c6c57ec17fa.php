            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('type.index')); ?>" class="nav-link">Jenis Limbah</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('trash.index')); ?>" class="nav-link">Limbah</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('room.index')); ?>" class="nav-link">Ruangan</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('user.index')); ?>" class="nav-link">Pengguna</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('report.index')); ?>" class="nav-link">Laporan</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('transaction.index')); ?>" class="nav-link">Transaksi</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('types.index')); ?>" class="nav-link">Jenis Limbah</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('trashes.index')); ?>" class="nav-link">Limbah</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('rooms.index')); ?>" class="nav-link">Ruangan</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('users.index')); ?>" class="nav-link">Pengguna</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('reports.index')); ?>" class="nav-link">Laporan</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('transactions.index')); ?>" class="nav-link">Transaksi</a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH D:\xampp\htdocs\bank_sampah\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>