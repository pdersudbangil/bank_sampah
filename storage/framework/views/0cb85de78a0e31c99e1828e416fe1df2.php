            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="<?php echo e(route('dashboard')); ?>" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(asset('bank_sampah/images/logo2.jpg')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(asset('bank_sampah/images/logo2.jpg')); ?>" alt="" height="50" class="rounded-circle">
                        </span>
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e(asset('bank_sampah/images/logo2.jpg')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
...
<?php /**PATH D:\xampp\htdocs\bank_sampah\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>