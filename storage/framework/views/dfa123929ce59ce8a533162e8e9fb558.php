                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Joseph Parker</td> -->
                            <td><?php echo e($TypeTrash->type_of_trash); ?></td>
                            <!-- <td><span class="badge bg-danger">High</span></td> -->
                            <td>
                                <a class=" btn btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#editModal<?php echo e($TypeTrash->id); ?>">Edit</a>
                                <a class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteRecordModal<?php echo e($TypeTrash->id); ?>">Delete</a>
                            </td>
                        </tr>
                        <div class="modal fade" id="editModal<?php echo e($TypeTrash->id); ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="<?php echo e(route('type.update', $TypeTrash->id)); ?>" autocomplete="off"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="customername-field" class="form-control"
                                                    ...
                                                    value="<?php echo e(old('name', $TypeTrash->type_of_trash)); ?>" required />
                        ...
                        <!-- Modal -->
                        <div class="modal fade zoomIn" id="deleteRecordModal<?php echo e($TypeTrash->id); ?>" tabindex="-1"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('type.destroy', $TypeTrash->id)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('type.store')); ?>" autocomplete="off" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bank_sampah\resources\views/bank_sampah/pages/type/index.blade.php ENDPATH**/ ?>