            ...
            <main class="grid grid-cols-2 gap-6 items-center">
                ...
                <div class="bg-white p-5 rounded-lg shadow-lg ring-1 ring-gray-200 dark:bg-zinc-900 dark:ring-zinc-800">
                    ...
                    <form action="<?php echo e(route('login')); ?>" method="POST" class="mt-4">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email"
                                ...
                                placeholder="Enter your email" value="<?php echo e(old('email', 'admin@themesbrand.com')); ?>">
                        </div>
                        ...
                        <div class="flex justify-between text-sm mt-2">
                            ...
                            <a href="<?php echo e(route('password.update')); ?>" class="text-green-600 hover:underline">Forgot password?</a>
                        </div>
                    ...
                    <p class="text-center text-sm text-gray-600 mt-2">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-green-600 font-semibold hover:underline">Sign Up</a>
                    </p>
                </div>
            </main>
...
<?php /**PATH D:\xampp\htdocs\bank_sampah\resources\views/bank_sampah/welcome.blade.php ENDPATH**/ ?>