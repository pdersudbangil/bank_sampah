            ...
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#editModal{{$room->id}}">Edit</a>
                                <a class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteRecordModal{{$room->id}}">Delete</a>
                            </td>
                        </tr>
                        ...
                        <!-- Modal -->
                        <div class="modal fade zoomIn" id="deleteRecordModal{{$room->id}}" tabindex="-1"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
